...
As Classes são chamadas de _blueprints_ dos objetos. Em tese, é um objeto que engloba os outros. A consequência disso é a herança dos métodos. <br>
Adicionei Classes e construtores no script.js.
